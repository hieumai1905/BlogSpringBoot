          ...
          <div class="col-lg-12 col-md-12">
            <div class="breadcrumb__text">
              ...
              <div class="breadcrumb__option">
                <a href="#">Home</a><span class="font-weight-bold">${account.fullname}</span>
                <input type="hidden" id="author_id" value="${account.accountId}">
              </div>
            </div>
            <div class="row">
...
<script src="../../static/js/post_by_author.js"></script>
</body>
